...
const inputStyleMappingClasses = {
  small: "RFFTextField-inputSizeSmall",
  medium: "RFFTextField-inputSizeMedium",
  large: "RFFTextField-inputSizeLarge",
  xlarge: "RFFTextField-inputSizeXLarge",
};

const classes = {
  root: "RFFTextField-root",
  input: "RFFTextField-input",
  inputBorder: "RFFTextField-inputBorder",
};
...
export interface RFFTextFieldProps
  extends Omit<FilledTextFieldProps | StandardTextFieldProps, "size"> {
  noBorder?: boolean;
  size?: "small" | "medium" | "large" | "xlarge";
}

function TextField(props: RFFTextFieldProps) {
  const {
    InputProps = {},
    InputLabelProps,
    noBorder,
